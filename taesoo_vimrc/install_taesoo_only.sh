...
if grep microsoft /proc/version; then
	...
	echo "Following manual configurations are necesasry!!!"
	...
	echo "1. edit ~/.config/nvim/init.vim"
	#echo "     set clipboard+=unnamedplus --> unnamed"
	echo "     remove g:clipboard=... lines"
	echo "2. you need to install xclip if you are using X11, otherwise install wl-copy and wl-paste if Wayland is in use."
fi
